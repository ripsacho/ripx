...
let params = [
  shop_domain, name, type, target_type || null, target_id || null,
  status, goal ? JSON.stringify(goal) : '{}', variants ? JSON.stringify(variants) : '[]',
  scheduled_start_at || null, scheduled_stop_at || null,
