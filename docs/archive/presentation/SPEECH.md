...
_Use when time is limited. Hit these slides only: 1, 2, 5, 6, 7, 9, 16, 17, 19, 20._
...
3. **Architecture** — "Storefront script → backend API → PostgreSQL. Node, Express, React."
4. **8 Test Types** — "Price, content, shipping, offers, checkout — full funnel."
5. **Multi-Variant** — "A/B/C, custom allocation, consistent hash, sample size calculator."
6. **Advanced Analytics** — "Profit, funnel, heatmap, events, time-series."
7. **Tech Stack** — "Node.js, Express, PostgreSQL, Redis, Bull, React, Vite, TanStack Query, Polaris, Recharts. Docker, Jest, Playwright. Modern, production-grade, battle-tested."
8. **Features** — "Connect → Dashboard → Create (wizard) → Run → Analyze & Act. Five steps, end to end."
9. **Why RipX** — "Rigor, 8 types, multi-platform, integrations, production-ready."
...
**One-liner:** _"RipX is built with Node.js, Express, PostgreSQL, Redis, React, Vite, and TanStack Query — a modern, production-grade stack that's battle-tested, scalable, and Docker-ready."_
...
**Ultra-short flow:** _Connect → Dashboard → Create (wizard) → Run → Analyze & Act_
