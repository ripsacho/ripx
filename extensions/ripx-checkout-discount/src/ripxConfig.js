 ...
 */
export const RIPX_PRICE_RESOLVE_BATCH_URL = "https://pickup-spy-being-london.trycloudflare.com/api/track/price-resolve-batch";
export const RIPX_SHIPPING_RESOLVE_BATCH_URL = "https://pickup-spy-being-london.trycloudflare.com/api/track/shipping-resolve-batch";
