...
export const RIPX_PRICE_RESOLVE_BATCH_URL =
  'https://window-reservoir-ratings-centuries.trycloudflare.com/api/track/price-resolve-batch';
export const RIPX_SHIPPING_RESOLVE_BATCH_URL =
  'https://window-reservoir-ratings-centuries.trycloudflare.com/api/track/shipping-resolve-batch';
